...
- La pausa se publicó en el commit funcional `7628074708e379dd5c79b9b76f3102022e25a5a6`. GitHub Actions aprobó lint, tipos, unitarias y build; Vercel completó el deployment Production. En `mybestversion.life`, el dominio y las rutas públicas respondieron correctamente, `GET /api/integrations/google-calendar/status` devolvió `404 {"error":"CALENDAR_DISABLED"}` y `GET /api/integrations/google-calendar/maintenance` devolvió `204`, sin escrituras ni creación de datos.
