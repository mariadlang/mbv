...
| --- | --- | --- | --- | --- | --- |
| 2026-09-16 | Excepción editorial de landing: Playfair Display + Inter; tracker permanece en Nunito Sans | Producto, Diseño e Ingeniería | Alcance absoluto de la decisión tipográfica P1, no su regla para producto | Añade jerarquía editorial sólo bajo `.landing-page`; no cambia el tracker | `typography.md`, `../decisions/0008-current-typography-system.md`, `index.md` |
