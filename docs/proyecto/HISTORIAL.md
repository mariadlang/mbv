...
- **Estado de entrega técnica:** código, pruebas, empaquetado y documentación quedan cerrados. La integración real permanece desactivada de forma segura hasta aplicar la migración, configurar credenciales OAuth y secretos server-side, registrar la Redirect URI HTTPS y disponer de ejecución periódica para mantenimiento.
