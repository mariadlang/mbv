...
export interface PlatformSummary { total_users: number; new_users_week: number; new_users_month: number; active_today: number; active_7d: number; active_30d: number; analytics_v2_cohort_users: number; onboarding_rate: number; activation_rate: number; retention_7d: number; retention_30d: number; pending_suggestions: number; open_support: number }
