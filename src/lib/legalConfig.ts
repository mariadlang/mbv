...
export const verifiedProviders = [
  { name: "Supabase", purpose: "Autenticación, cuentas, preferencias, registros legales y almacenamiento server-side de la integración de Calendar", data: "Nombre, correo, identificador de cuenta, sesión, preferencias, evidencias mínimas de consentimiento, credenciales de Calendar cifradas y copia operativa de sincronización", role: "Proveedor tecnológico / encargado según el tratamiento", location: "Infraestructura internacional; la región concreta del proyecto debe documentarse", retention: "Según la vigencia de la cuenta; los datos de Calendar se eliminan al desconectar la integración desde la app o suprimir la cuenta", policyUrl: "https://supabase.com/privacy", international: true },
...
export const dataInventory = [
  ...
  { category: "Google Calendar opcional", examples: "Cuenta conectada, calendarios elegidos, títulos, descripciones, fechas, horas, zonas horarias, estados e identificadores de eventos", storage: "Tokens cifrados y copia operativa de sincronización en tablas server-only de Supabase; fuente en Google", sensitive: true },
