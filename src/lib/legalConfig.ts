...
export const legalDocuments: LegalDocumentDefinition[] = [
  { id: "terms", type: "terms", title: "Términos y Condiciones", version: LEGAL_VERSION, effectiveDate: "2026-09-11", updatedAt: "2026-09-11", contentReference: "/terms", active: true },
  { id: "data-policy", type: "data_policy", title: "Política de Tratamiento de Datos", version: LEGAL_VERSION, effectiveDate: "2026-09-11", updatedAt: "2026-09-11", contentReference: "/data-policy", active: true },
  { id: "privacy-notice", type: "privacy_notice", title: "Aviso de Privacidad", version: LEGAL_VERSION, effectiveDate: "2026-09-11", updatedAt: "2026-09-11", contentReference: "/privacy", active: true },
  { id: "cookies", type: "cookies", title: "Política de Cookies", version: COOKIE_POLICY_VERSION, effectiveDate: "2026-09-11", updatedAt: "2026-09-11", contentReference: "/cookies", active: true },
  { id: "payments", type: "payments", title: "Suscripciones y pagos", version: LEGAL_VERSION, effectiveDate: "2026-09-11", updatedAt: "2026-09-11", contentReference: "/payments", active: true },
  { id: "retract", type: "retract", title: "Derecho de retracto", version: LEGAL_VERSION, effectiveDate: "2026-09-11", updatedAt: "2026-09-11", contentReference: "/retract", active: true },
  { id: "ai", type: "ai", title: "Uso de Inteligencia Artificial", version: LEGAL_VERSION, effectiveDate: "2026-09-11", updatedAt: "2026-09-11", contentReference: "/ai-privacy", active: true },
];

export const verifiedProviders = [
  { name: "Supabase", purpose: "Autenticación, cuentas, preferencias, registros legales, analítica propia consentida y almacenamiento server-side de datos históricos de Calendar", data: "Nombre, correo, identificador de cuenta, sesión, preferencias, evidencias mínimas de consentimiento, eventos técnicos con metadata cerrada, credenciales de Calendar cifradas y copia operativa histórica", role: "Proveedor tecnológico / encargado según el tratamiento", location: "Infraestructura internacional; la región concreta del proyecto debe documentarse", retention: "Según la vigencia de la cuenta y la política aplicable; la cola analítica local se limita a 30 días y los datos históricos de Calendar se eliminan mediante una solicitud procedente o al suprimir la cuenta", policyUrl: "https://supabase.com/privacy", international: true },
  ...
  { name: "Google Calendar API", purpose: "Integración opcional actualmente pausada; referencia histórica para conexiones autorizadas anteriormente", data: "Correo de la cuenta conectada, lista de calendarios y títulos, descripciones, fechas, horas, zonas horarias, estados e identificadores de eventos", role: "Proveedor de integración bajo autorización independiente", location: "Infraestructura internacional", retention: "La revocación desde Google detiene accesos futuros; la copia histórica puede eliminarse mediante una solicitud de supresión procedente", policyUrl: GOOGLE_API_USER_DATA_POLICY_URL, international: true },
...
export const dataInventory = [
  ...
  { category: "Google Calendar histórico · integración pausada", examples: "Cuenta conectada, calendarios elegidos, títulos, descripciones, fechas, horas, zonas horarias, estados e identificadores de eventos", storage: "Tokens cifrados y copia operativa histórica en tablas server-only de Supabase; sin sincronización activa", sensitive: true },
  ...
  { category: "Analítica opcional y referrals", examples: "Eventos técnicos cerrados, sesión de producto y código opaco de invitación; nunca texto del planner ni contenido compartido", storage: "Cola temporal local y Supabase únicamente con consentimiento analítico; atribución de llegada local hasta 29 días", sensitive: false },
] as const;
