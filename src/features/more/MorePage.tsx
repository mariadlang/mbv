...
import { Banknote, BarChart3, BookOpen, ChevronRight, Dumbbell, Feather, HeartPulse, LayoutGrid, ListTodo, Settings, Sparkles, Target } from "lucide-react";
...
const groups = [
  ...
  { title: "CUIDARME", links: [["/app/life-hub?tab=fitness", "Fitness Hub", "Entrenamiento y check-ins a tu manera.", Dumbbell], ["/app/habits", "Hábitos y bienestar", "Hábitos, ánimo, energía, sueño y enfoque.", HeartPulse]] },
