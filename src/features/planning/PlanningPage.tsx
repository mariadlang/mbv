...
export function PlanningPage({ planner, initialView = "year" }: { planner: PlannerController; initialView?: PlanningView }) {
  ...
  return <div className="page-stack cascade-page planning-v2">
    {view === "year" && <PlanningOverview snapshot={snapshot} fiveYearPlan={fiveYearPlan} threeYearPlan={threeYearPlan} visibleMonthPlans={visibleMonthPlans} selectedYear={selectedYear} availableYears={availableYears} todayKey={todayKey} onYearChange={setSelectedYear} onAddMonth={openCreateMonth} onEditLongTerm={openLongTerm} onOpenMonth={openMonthDetail} onEditMonth={openEditMonth} onOpenWeek={() => setView("week")} onOpenDay={() => setView("day")} onOpenReset={() => setView("reset")} />}
