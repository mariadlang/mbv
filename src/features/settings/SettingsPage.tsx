  ...
  return <div className="page-stack settings-reference">
    ...
    <div className="settings-reference-layout">
      <Card id="account-settings" className="settings-list-card">
        ...
        <section><div><strong>Fitness Hub</strong><small>Úsalo cuando quieras acompañar ejercicios, comidas, medidas y fotos; puedes ocultarlo sin perder datos.</small></div><button type="button" className={`privacy-toggle ${fitnessEnabled ? "is-on" : ""}`} aria-pressed={fitnessEnabled} onClick={() => setFitnessEnabled(!fitnessEnabled)}><span />{fitnessEnabled ? "Visible en Mi espacio" : "Oculto por ahora"}</button></section>
