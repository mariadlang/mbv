...
export function HelpPage({ planner }: { planner: PlannerController }) {
  ...
  const applyTool = async (event: FormEvent) => {
    ...
    if (destination === "today") {
      ...
      setMessage("La acción quedó añadida a Hoy.");
