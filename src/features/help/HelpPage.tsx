...
export function HelpPage({ planner }: { planner: PlannerController }) {
  ...
  return <div className="page-stack help-page">
    ...
    {message && <p className="inline-message" role="status">{message} <Link to={destination === "today" ? "/app/today" : destination === "later" ? "/app/life-hub?tab=lists" : "/app/life-hub"}>Ver ahora</Link></p>}
