...
export function JournalPage({ planner }: { planner: PlannerController }) {
  ...
  return <div className="page-stack journal-page-new">
    ...
    {showReflections ? <div className="journal-reflection-view">
      ...
      <Card className="weekly-review-cta"><Feather size={25} /><p className="eyebrow">Cierre del ciclo</p><h2>Cierre mensual</h2><p>Conecta lo aprendido con el próximo mes y su primera semana.</p><Link className="button button--secondary" to="/app/planning?view=reset">Abrir cierre mensual</Link></Card>
