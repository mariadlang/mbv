...
export function GoalsPage({ planner }: { planner: PlannerController }) {
  ...
  const form = useForm<GoalFormInput>({ resolver: zodResolver(goalFormSchema), defaultValues: { title: "", reason: "", targetDate: "", lifeAreaId: "" } });
