...
const empty: PlatformData = { summary: { total_users:0,new_users_week:0,new_users_month:0,active_today:0,active_7d:0,active_30d:0,analytics_v2_cohort_users:0,onboarding_rate:0,activation_rate:0,retention_7d:0,retention_30d:0,pending_suggestions:0,open_support:0 }, users:[], usage:[], tickets:[], faqs:[], categories:[], settings:[], audit:[] };
