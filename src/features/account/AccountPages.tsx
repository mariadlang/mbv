...
export function PrivacyPage() {
  return <PublicFrame><article className="legal-page">
    ...
    <p className="legal-page__updated">Última actualización: 8 de septiembre de 2026</p>
    ...
    <section><h2>3. Cómo usamos la información</h2><p>Usamos la información de cuenta para autenticarte, proteger el acceso, mantener tus preferencias y habilitar las funciones correspondientes a tu plan.</p><p>Si autorizas la categoría Analítica, registramos eventos técnicos de uso vinculados a tu cuenta para entender activación y funcionamiento. No incluyen nombres, correos, títulos, contenido del journal ni información de salud o finanzas. No vendemos tus datos personales ni los utilizamos para publicidad personalizada.</p></section>
...
export function CookiesPage() {
  return <PublicFrame><article className="legal-page">
    <p className="eyebrow">INFORMACIÓN LEGAL</p><h1>Cookies y almacenamiento local</h1><p className="legal-page__updated">Última actualización: 8 de septiembre de 2026</p>
